...
(* OASIS_START *)
(* DO NOT EDIT (digest: 24a9767f61ca621c87af9da7d993c483) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-block-fs", None);
                           FindlibPackage ("lwt", None);
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "recOramMacroBench.ml"
                   });
               Executable
                 ({
                     cs_name = "control_macro_bench";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "controlMacroBench.ml"
                   });
               Executable
                 ({
                     cs_name = "initialise_oram";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "initialiseOram.ml"});
               Executable
                 ({
                     cs_name = "initialise_recursive_oram";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "initialiseRecursiveOram.ml"
                   });
               Executable
                 ({
                     cs_name = "block_size_experiment";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "blockSizeExperiment.ml"
                   });
               Executable
                 ({
                     cs_name = "read_same_block";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "readSameBlock.ml"});
               Executable
                 ({
                     cs_name = "initialise_encrypted_oram";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "initialiseEncryptedOram.ml"
                   });
               Executable
                 ({
                     cs_name = "encrypted_time_experiment";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "encryptedTimeExperiment.ml"
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\189\1380\152\202\176+\169\005P)\tm\199N\176";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
